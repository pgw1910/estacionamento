...
const registros = [
  { id: '1', nome: 'Tales', data: '20/05', placa: 'W54DE',  chegada: '08:10', saida: '08:00', tipo: 'moto' },
  { id: '2', nome: 'Tales', data: '19/05', placa: 'D45AS',  chegada: '08:00', saida: '12:16', tipo: 'carro' },
  { id: '3', nome: 'Tales', data: '18/05', placa: 'W54DE',  chegada: '08:13', saida: '12:10', tipo: 'moto' },
  { id: '4', nome: 'Tales', data: '17/05', placa: 'W54DE',  chegada: '08:03', saida: '12:07', tipo: 'moto' },
];

export default function HistoricoGeralScreen({ navigation }) {
  return (
        ...
        renderItem={({ item }) => (
          <View style={styles.histItem}>
            <View style={styles.histLeft}>
              <Text style={styles.histName}>{item.nome}</Text>
              <Text style={styles.histDate}>{item.data}</Text>
              <Text style={styles.histPlate}>{item.placa}</Text>
            </View>
            <View style={styles.histTimes}>
              <Text style={styles.histTimeLabel}>Horário de Chegada</Text>
              <Text style={styles.histTimeVal}>{item.chegada}</Text>
              <Text style={styles.histTimeLabel}>Horário de Saída</Text>
              <Text style={styles.histTimeVal}>{item.saida}</Text>
            </View>
            <Ionicons
              name={item.tipo === 'moto' ? 'bicycle-outline' : 'car-outline'}
